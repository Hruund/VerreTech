        ...
        <form class="container mx-auto mb-12">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <input v-model="article_desc" class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="article-desc" type="text" placeholder="Parroi de douche en verre trempé ultra-résistante.">
                </div>
            </div>
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input v-model="article_price" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="price" type="number" placeholder="100">
            </div>
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
