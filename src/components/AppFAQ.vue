<template>
    <div id="faq" class="mx-auto container">
        ...
        <div id="faq" class="p-4 text-left">
            ...
            <div class="text-left text-gray-900 text-2xl font-bold mt-6">
                2. Je ne suis pas satisfait de ma commande, puis-je être remboursé ?
                <hr style="height: 2px; width: 50%;">
            </div>
            <p>
            ...
            <div class="text-left text-gray-900 text-2xl font-bold mt-6">
                3. Comment faire pour vous contacter ?
                <hr style="height: 2px; width: 50%;">
            </div>
            <p>
                Vous avez toutes les informations de contact depuis notre page "Contactez-nous".
            </p>
